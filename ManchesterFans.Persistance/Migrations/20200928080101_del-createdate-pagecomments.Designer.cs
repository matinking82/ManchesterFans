...
namespace ManchesterFans.Persistance.Migrations
{
    ...
    [Migration("20200928080101_del-createdate-pagecomments")]
    partial class delcreatedatepagecomments
    {
            ...
            modelBuilder.Entity("ManchesterFans.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            InsertTime = new DateTime(2020, 9, 28, 11, 31, 0, 981, DateTimeKind.Local).AddTicks(1133),
                            IsRemoved = false,
                            Level = 10,
