...
namespace ManchesterFans.Persistance.Migrations
{
    ...
    [Migration("20201103074923_Add-Table-SliderPages")]
    partial class AddTableSliderPages
    {
            ...
            modelBuilder.Entity("ManchesterFans.Domain.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            LoginId = 1,
                            InsertTime = new DateTime(2020, 11, 3, 11, 19, 22, 464, DateTimeKind.Local).AddTicks(7757),
                            IsRemoved = false,
                            Level = 10,
